...
<html>
    ...
    <body>
        ...
        <div id="show-transactions" class="content scaffold-show" role="main">
            ...
            <f:display bean="transactions" />
            <g:form resource="${this.transactions}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.transactions}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
